...
def parse_args():
    ...
    parser.add_argument('--method', type=str,
                        default='ours_no_lrp',
                        choices=['dsm', 'eigen_cam', 'dsm_grad', 'dsm_grad_cam', 'ours_with_lrp', 'rollout', 'partial_lrp', 'transformer_att',
                                 'raw_attn', 'attn_gradcam', 'rm_with_lrp_no_normalization', 'rm_no_lrp',
                                 'rm_no_lrp_no_norm', 'ablation_no_aggregation', 'ablation_no_self_in_10'],
                        help='')
